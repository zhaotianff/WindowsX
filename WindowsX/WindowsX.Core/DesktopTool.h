...
typedef BOOL(WINAPI* PFN_GET_WINDOW_COMPOSITION_ATTRIBUTE)(HWND, WINDOWCOMPOSITIONATTRIBDATA*);
...
SILVERAROWANACORE_API BOOL GetLink(LPCWSTR lpszLinkFile, LPWSTR lpszPath, int iPathBufferSize);
...
SILVERAROWANACORE_API LPTSTR GetProcessNameFromHwnd(HWND hWnd);
SILVERAROWANACORE_API BOOL GetFileExtensionFriendlyName(LPCTSTR szExtension, LPTSTR buffer, DWORD bufferSize);
SILVERAROWANACORE_API BOOL GetFileExtensionExecutablePath(LPCTSTR szExtension, LPTSTR buffer, DWORD bufferSize);
...
SILVERAROWANACORE_API VOID SelectFile(LPCTSTR lpszFile);
SILVERAROWANACORE_API VOID OpenFileProperty(LPCTSTR lpszFile);

SILVERAROWANACORE_API VOID OpenWindowsHelp();
SILVERAROWANACORE_API VOID OpenRunDialog(LPTSTR command);
SILVERAROWANACORE_API VOID OpenSearchWindow(LPCTSTR inputs);